...
<div style="display: flex; justify-content: center; align-items: center; flex-direction: column;"> <img src="https://i.imghippo.com/files/0xEtn1712958293.png" alt="Sophia Logo" style="max-width: 100px;"> <p style="font-size: 24px; font-weight: bold; margin-top: 20px; text-align: center;">🎨 Sophia: The Next-Generation Design Creation Platform 🌐</p> </div>
